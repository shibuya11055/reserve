 ...
 * });
 */
export function useTestFieldQuery(
  baseOptions?: Apollo.QueryHookOptions<TestFieldQuery, TestFieldQueryVariables>
) {
  const options = { ...defaultOptions, ...baseOptions }
  return Apollo.useQuery<TestFieldQuery, TestFieldQueryVariables>(
    TestFieldDocument,
    options
  )
}
export function useTestFieldLazyQuery(
  baseOptions?: Apollo.LazyQueryHookOptions<
    TestFieldQuery,
    TestFieldQueryVariables
  >
) {
  const options = { ...defaultOptions, ...baseOptions }
  return Apollo.useLazyQuery<TestFieldQuery, TestFieldQueryVariables>(
    TestFieldDocument,
    options
  )
}
export type TestFieldQueryHookResult = ReturnType<typeof useTestFieldQuery>
export type TestFieldLazyQueryHookResult = ReturnType<
  typeof useTestFieldLazyQuery
>
export type TestFieldQueryResult = Apollo.QueryResult<
  TestFieldQuery,
  TestFieldQueryVariables
>
